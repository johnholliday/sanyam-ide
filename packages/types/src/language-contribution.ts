...
export interface LanguageContribution {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // SPROTTY DIAGRAM MODULE
  // ═══════════════════════════════════════════════════════════════════════════

  /**
   * Optional Sprotty diagram module for custom views.
   *
   * Provides InversifyJS bindings for grammar-specific Sprotty model elements,
   * views, and styling. Generated by `/grammar.config` when diagram tags
   * are present in the grammar.
   *
   * @example
   * ```typescript
   * import { workflowDiagramModule } from './diagram/index.js';
   *
   * export const contribution: LanguageContribution = {
   *   // ...
   *   diagramModule: workflowDiagramModule,
   * };
   * ```
   */
...
export interface GrammarPackageJson {
  ...
  readonly sanyam?: {
    ...
    /**
     * Path to Sprotty diagram module export.
     * Relative to package root.
     *
     * @example './lib/diagram/module.js'
     */
    readonly diagramModule?: string;
  };
}
