---
title: "Examples"
description: "Real-world ECML examples from basic to advanced"
...
Learn ECML through practical examples, organized from basic to advanced.

## Basic Examples

Start here if you're new to ECML.
...
| Example | Location |
|---------|----------|
| Basic examples | `workspace/ecml/basic/` |
| Intermediate | `workspace/ecml/intermediate/` |
| Advanced | `workspace/ecml/advanced/` |
